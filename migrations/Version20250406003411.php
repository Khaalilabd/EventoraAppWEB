 ...
 */
final class Version20250406003411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE membres (id INT AUTO_INCREMENT NOT NULL, Nom VARCHAR(255) NOT NULL, Prénom VARCHAR(255) NOT NULL, Email VARCHAR(255) NOT NULL, CIN VARCHAR(255) NOT NULL, NumTel VARCHAR(255) NOT NULL, Adresse VARCHAR(255) NOT NULL, motDePasse VARCHAR(255) NOT NULL, Role VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, isConfirmed TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE feedback ADD CONSTRAINT FK_D2294458FE6E88D7 FOREIGN KEY (idUser) REFERENCES membres (id)');
        ...
        $this->addSql('ALTER TABLE reclamation ADD CONSTRAINT FK_CE606404FE6E88D7 FOREIGN KEY (idUser) REFERENCES membres (id)');
